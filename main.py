...
# todo 5: Create a new "WindowHandler" module that creates a new window when clicking on certain buttons
...
# ------ LABEL SETUP --------- #
title_label = Label(text = f"To Do List", font = FONT)
title_label.grid(column = 1, row = 0)


# ------ BUTTON SETUP --------- #
add_button = Button(text = "Add", command = lambda: new_task.open_new_window(root))
